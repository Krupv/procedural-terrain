...
nmap B \\b
omap B \\b
xnoremap <silent> C-a :call neobundle#autoload#mapping('C-a', 'syntastic', 'v')
nnoremap <silent> C-a :call neobundle#autoload#mapping('C-a', 'syntastic', 'n')
xmap E \\e
nmap E \\e
omap E \\e
nmap H <Plug>(easymotion-linebackward)
xmap H <Plug>(easymotion-linebackward)
omap H <Plug>(easymotion-linebackward)
...
xmap L <Plug>(easymotion-lineforward)
omap L <Plug>(easymotion-lineforward)
nmap Q gq
xmap Q gq
omap Q gq
xmap W \\w
...
xnoremap \c :call g:ClangUpdateQuickFix()
nnoremap \c :call g:ClangUpdateQuickFix()
nnoremap \q q 
nnoremap \l l
xnoremap \l l
onoremap \l l
...
onoremap \h h
nnoremap \r :%s/
xnoremap \m :w!urxvt -name make -hold -e sh -c  "mmake" &
nnoremap \mc :w:!urxvt -name make -hold -e sh -c "mmake" &
xnoremap \mc :w:!urxvt -name make -hold -e sh -c "mmake" &
onoremap \mc :w:!urxvt -name make -hold -e sh -c "mmake" &
nnoremap \mr :w:!urxvt -name make -hold -e sh -c "mmake" &
...
xnoremap \ev :sp $MYVIMRC
onoremap \ev :sp $MYVIMRC
xnoremap \s :wgv
nnoremap \s :w
nnoremap \G :Google 
xnoremap \G :Google 
onoremap \G :Google 
xnoremap <silent> \t :call neobundle#autoload#mapping('<leader>t', 'tagbar', 'v')
nmap \t :TagbarToggle
onoremap <silent> \b :call neobundle#autoload#mapping('<leader>b', 'ctrlp.vim', 'o')
xnoremap <silent> \b :call neobundle#autoload#mapping('<leader>b', 'ctrlp.vim', 'x')
nnoremap <silent> \b :call neobundle#autoload#mapping('<leader>b', 'ctrlp.vim', 'n')
xnoremap ` ;
nnoremap ` ;
xmap b \\b
nnoremap cc xi
...
onoremap <silent> nvi :call neobundle#autoload#mapping('nvi', 'ctrlp.vim', 'o')
xnoremap <silent> nvi :call neobundle#autoload#mapping('nvi', 'ctrlp.vim', 'x')
nnoremap <silent> nvi :call neobundle#autoload#mapping('nvi', 'ctrlp.vim', 'n')
xnoremap rr "_dd
xnoremap r "_d
nnoremap rr "_dd
nnoremap r "_d
...
imap  <Plug>TComment_
inoremap <silent> C-a :call neobundle#autoload#mapping('C-a', 'syntastic', 'i')
inoremap \c :call g:ClangUpdateQuickFix()
inoremap \q q
inoremap \r :%s/
inoremap \m :w!urxvt -name make -hold -e sh -c "mmake" &
inoremap \s :wa
...
set shortmess=aoO
badd +14 CoreEngine.hpp
badd +0 CoreEngine.cpp
badd +9 generator/Landscape.hpp
badd +0 generator/Landscape.cpp
badd +8 generator/Generator.hpp
badd +0 generator/Generator.cpp
badd +1 generator/Chunk.hpp
badd +0 generator/Chunk.cpp
badd +5 generator/TerrainCell.hpp
badd +0 generator/TerrainCell.cpp
argglobal
silent! argdel *
argadd CoreEngine.hpp
set stal=2
edit generator/Generator.hpp
...
exe 'vert 1resize ' . ((&columns * 119 + 119) / 239)
exe 'vert 2resize ' . ((&columns * 119 + 119) / 239)
tabedit generator/Landscape.hpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
exe 'vert 1resize ' . ((&columns * 119 + 119) / 239)
exe 'vert 2resize ' . ((&columns * 119 + 119) / 239)
tabedit generator/TerrainCell.hpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit generator/TerrainCell.cpp
nnoremap <buffer> <silent> 	 :python updateSnips()
xnoremap <buffer> <silent> 	 :python updateSnips()
onoremap <buffer> <silent> 	 :python updateSnips()
nnoremap <buffer> <silent>  
