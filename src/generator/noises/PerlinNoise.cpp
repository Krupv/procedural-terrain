...
{
	if (m_power)
		return pow(scaled_octave_noise_2d( (float) m_octaves, m_persistence, m_scale, 0.f, m_maxHeight, (float) _x, (float) _y), 2.0);
	else
		return scaled_octave_noise_2d( (float) m_octaves, m_persistence, m_scale, 0.f, m_maxHeight, (float) _x, (float) _y);
}
